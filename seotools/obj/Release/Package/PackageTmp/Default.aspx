<%@ Page Title="" Language="C#" MasterPageFile="~/seotools.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="seotools.WebForm1" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Title" runat="server">Home Page</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="head" runat="server"></asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
<h2>Jeremy's SEO Tools</h2>
